                        ...
                        {matches.map((match) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {/* Driver 1 */}
                              <div
                                className={`${styles.driverSlot} ${d1Wins ? styles.winner : ""} ${match.status === "completed" && !d1Wins ? styles.loser : ""}`}
                              >
                                <span className={styles.slotName}>
                                  {d1Name}
                                </span>
                                {d1Wins && (
                                  <span className={styles.winBadge}>W</span>
                                )}
                              </div>
                              ...
                              {/* Driver 2 */}
                              <div
                                className={`${styles.driverSlot} ${d2Wins ? styles.winner : ""} ${match.status === "completed" && !d2Wins ? styles.loser : ""}`}
                              >
                                <span className={styles.slotName}>
